...
class RunSocio(RunObj):
    def __init__(self):
        super().__init__()
        self.file_format_path = "C:/Work/Haaraha/assesmenttalpiotcodes-main/Formats/socio_format.docx"
...
class RunSagzab(RunObj):
    def __init__(self):
        super().__init__()
        self.file_format_path = "C:/Work/Haaraha/assesmenttalpiotcodes-main/Formats/mashov_mefakdim_format.docx"
...
if __name__ == '__main__':
    VERBOSE = False
    run_socio = True
    # output_dir_socio = r"C:\Users\t9155275\PycharmProjects\assesmenttalpiotcodes\sociometry_output"
    output_dir_sagab_sagaz = r"C:\Work\Haaraha\assesmenttalpiotcodes-main\Socio_and_Sagabz\output_2"
    output_dir_socio = output_dir_sagab_sagaz
